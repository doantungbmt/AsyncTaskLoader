...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<UserAccount>>,
        ...
        if(loader.getId() == LOADER_ID_USERACCOUNT) {
            ...
            for(UserAccount userAccount: data)  {
                sb.append("Username:" ).append(userAccount.getUserName()).append("\t") //
                        ...
                        .append("Fullname: ").append(userAccount.getFullName()).append("\n");
            }
